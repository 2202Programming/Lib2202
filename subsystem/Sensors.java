...
public class Sensors extends SubsystemBase implements IHeadingProvider {
  /**
   ...
   * filtered together.
   * 
   * Code copied from 2025 sensors_subsystem.
   * Only supports Pigeon, we no longer use NavX.
   * 
   */

  // if no-args Sensors is used, this is our typical ID.
  // Otherwise use custom constructor with an ID from your robots Constants file.
  final static int PIGEON_IMU_CAN = 60;
  ...
  public Sensors(){
    this(PIGEON_IMU_CAN);
    System.out.print("Sensors() no-args constructor used, Pigeon on CANID=" + PIGEON_IMU_CAN);
  }

  public Sensors(int pigeon_can_id) {
    // alocate sensors
